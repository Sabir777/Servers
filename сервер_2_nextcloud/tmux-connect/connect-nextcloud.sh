...
tmux send-keys -t Connected:3.1 'sudo umount ~/mnt_user2_nextcloud ; sshfs user2@85.159.231.218:/home/user2 ~/mnt_user2_nextcloud ; cd ~/mnt_user2_nextcloud; ls' C-m
